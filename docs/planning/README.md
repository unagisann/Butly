...
| [Config Unification Plan: pydantic-settings](active/pydantic_settings_plan.md) | Phase 1 compatibility shim implemented | Phase 2 onward (per-module typed access, removing the legacy globals, adding env overrides once sections are typed) |
