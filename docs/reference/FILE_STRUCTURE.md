...
| `app.py` | Streamlit Web UI. Sends chat / settings via HTTP to the FastAPI backend. Includes generic Connection/API-key management, provider-first model selection, and the LoCoMo / Japanese-dialogue evaluation console. |
