...
| `app.py` | Streamlit Web UI. Sends chat / settings via HTTP to the FastAPI backend. Settings include generic Connection/API-key management and provider-first model selection for global and instance roles. |
