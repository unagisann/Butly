...
| `SearchPlanner` | `search_planner.py` | Called only on cortex; generates RAG search keywords |
...
| 3 | **MID-TERM (conditional)** | mid and above only (see below) |
| 4 | **CURRENT TIME** | Current timestamp (system note) |
| 5 | **RAG (conditional)** | cortex only (see below) |
| 6 | **FLOATING SUMMARY** | Floating summary of the latest dialogue flow |
| 7 | **TIER INFO** | Current thinking mode (reflex / mid / cortex) |
| 8 | **Short Term** | Last 6 turns of conversation history |
